...
export default class PhoneInput extends PureComponent {
  ...
  updateFlagAndFormatNumber(number, actionAfterSetState = null) {
    ...
    this.setState({ iso2, formattedNumber: phoneNumber }, () => actionAfterSetState && actionAfterSetState(phoneNumber));
  }
  ...
  setInputRef = (el) => { this.inputPhone = el; };

  setPickerRef = (el) => { this.picker = el; };
